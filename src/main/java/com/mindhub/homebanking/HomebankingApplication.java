...
public class HomebankingApplication {
									  ...
									  ClientLoansRepository clientLoansRepository)
	{
		return (args) -> // Devuelve un objeto de tipo CommandLineRunner que ejecuta un conjunto de tareas al inicio de la aplicación
		{
			...
			Client client = new Client("Melba", "Morel", "melba@mindhub.com"); // Crea un nuevo objeto "Client" con los parámetros especificados
			...
			Client client1 = new Client("Gerardo", "Medina", "Gerardomedina@gmail.com"); // Crea un nuevo objeto "Client" con los parámetros especificados
			clientRepository.save(client1); // Guarda el objeto "Client" en la base de datos

			Client client2 = new Client("Sandra", "Gomez", "sandrag@gmail.com"); // Crea un nuevo objeto "Client" con los parámetros especificados
